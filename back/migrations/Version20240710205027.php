 ...
 */
final class Version20240710205027 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE product_language (product_id INT NOT NULL, language_id INT NOT NULL, INDEX IDX_1F6B1B224584665A (product_id), INDEX IDX_1F6B1B2282F1BAF4 (language_id), PRIMARY KEY(product_id, language_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
